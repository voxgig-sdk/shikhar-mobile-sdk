...
The Golang SDK for the ShikharMobile API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
| `Authentication` | `(data map[string]any) ShikharMobileEntity` | Create an Authentication entity instance. |
