# ShikharMobile Golang SDK Reference

Complete API reference for the ShikharMobile Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *ShikharMobileSDK`
...
#### `Authentication(data map[string]any) ShikharMobileEntity`
