# ShikharMobile TypeScript SDK Reference

Complete API reference for the ShikharMobile TypeScript SDK.
...
```ts
new ShikharMobileSDK(options?: object)
```
...
#### `ShikharMobileSDK.test(testopts?, sdkopts?)`
...
**Returns:** `ShikharMobileSDK` instance in test mode.
...
Alias for `ShikharMobileSDK.test()`.
...
Return the parent `ShikharMobileSDK` instance.
