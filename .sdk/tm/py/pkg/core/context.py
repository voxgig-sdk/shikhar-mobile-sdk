...
from projectname_sdk.core.control import ShikharMobileControl
...
class ShikharMobileContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ShikharMobileControl()
        ...
        if isinstance(sp, ShikharMobileSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ShikharMobileResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ShikharMobileResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ShikharMobileError(code, msg, self)
