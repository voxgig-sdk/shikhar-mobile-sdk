...
class ShikharMobileTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ShikharMobileTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ShikharMobileTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ShikharMobileTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
