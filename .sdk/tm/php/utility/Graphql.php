...
// ShikharMobile SDK utility: graphql
//
...
class ShikharMobileGraphql
{
    ...
    // equivalent.
    public static function body(ShikharMobileContext $ctx): mixed
    {
    ...
    public static function errors(ShikharMobileContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
