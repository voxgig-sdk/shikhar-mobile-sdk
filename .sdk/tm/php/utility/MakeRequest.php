...
// ShikharMobile SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ShikharMobileMakeRequest
{
    public static function call(ShikharMobileContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ShikharMobileResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ShikharMobileResponse($fetched);
        } else {
