...
// ShikharMobile SDK proxy feature
...
class ShikharMobileProxyFeature extends ShikharMobileBaseFeature
{
    ...
    public function init(ShikharMobileContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ShikharMobileContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
