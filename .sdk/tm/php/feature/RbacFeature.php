...
// ShikharMobile SDK rbac feature
...
class ShikharMobileRbacFeature extends ShikharMobileBaseFeature
{
    ...
    private function _required(ShikharMobileContext $ctx): ?string
    {
    ...
    private function _reject(ShikharMobileContext $ctx, string $required): void
    {
    ...
    private function _track(ShikharMobileContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
