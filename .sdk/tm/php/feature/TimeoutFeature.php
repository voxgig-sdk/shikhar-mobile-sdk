...
// ShikharMobile SDK timeout feature
...
class ShikharMobileTimeoutFeature extends ShikharMobileBaseFeature
{
    ...
    private function _with_timeout(ShikharMobileContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ShikharMobileContext $_ctx, float $ms): void
    {
        $client = $this->client;
