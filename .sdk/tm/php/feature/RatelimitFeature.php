...
// ShikharMobile SDK ratelimit feature
...
class ShikharMobileRatelimitFeature extends ShikharMobileBaseFeature
{
    ...
    private function _acquire(ShikharMobileContext $ctx): void
    {
    ...
    private function _track(ShikharMobileContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
