...
// ShikharMobile SDK utility type

class ShikharMobileUtility
{
    ...
    public static function copy(ShikharMobileUtility $src): ShikharMobileUtility
    {
        $u = new ShikharMobileUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
