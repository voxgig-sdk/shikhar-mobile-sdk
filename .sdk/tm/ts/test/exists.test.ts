...
describe('exists', async () => {
  ...
  //
  // ShikharMobileSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof ShikharMobileSDK, true,
      'ShikharMobileSDK.test() must return a client synchronously')
  })
