...
#      offline in seeded test mode (ShikharMobileSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ShikharMobile_sdk.rb")
  SDK_CLASS = "ShikharMobileSDK"
