# ShikharMobile Lua SDK



The Lua SDK for the ShikharMobile API — an entity-oriented client using Lua conventions.
...
```lua
-- Create
local created, err = client:Authentication():create({ mobile = "example", password = "example" })
...
```
lua/
├── shikhar-mobile_sdk.lua    -- Main SDK module
...
The main module (`shikhar-mobile_sdk`) exports the SDK constructor
