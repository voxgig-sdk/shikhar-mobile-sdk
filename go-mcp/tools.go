...
func registerTools(server *mcp.Server, client *sdk.ShikharMobileSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "shikhar-mobile_list",
		Description: "List records from ShikharMobile. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "shikhar-mobile_load",
		Description: "Load a single record from ShikharMobile. " +
...
func runOp(client *sdk.ShikharMobileSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ShikharMobileSDK, name string) (sdk.ShikharMobileEntity, error) {
