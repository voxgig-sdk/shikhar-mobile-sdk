// Command ShikharMobile-mcp is an MCP server exposing the ShikharMobile
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ShikharMobile_list  — list records of an entity
//	ShikharMobile_load  — load a single record of an entity
//
