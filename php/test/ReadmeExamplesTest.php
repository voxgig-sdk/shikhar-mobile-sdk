...
// ShikharMobile SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ShikharMobileSDK::test)
...
{
    private const SDK_CLASS = 'ShikharMobileSDK';
    ...
    private const SDK_BASE = 'shikharmobile_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../shikharmobile_sdk.php';
