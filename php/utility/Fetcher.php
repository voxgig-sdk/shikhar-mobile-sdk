...
// ShikharMobile SDK utility: fetcher

class ShikharMobileFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ShikharMobileSDK/1.0)';
    ...
    public static function call(ShikharMobileContext $ctx, string $fullurl, array $fetchdef): array
    {
