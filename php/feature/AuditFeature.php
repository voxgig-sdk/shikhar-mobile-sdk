...
// ShikharMobile SDK audit feature
...
class ShikharMobileAuditFeature extends ShikharMobileBaseFeature
{
    ...
    private function _emit(ShikharMobileContext $ctx, string $outcome): void
    {
