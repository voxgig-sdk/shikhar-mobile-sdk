...
// ShikharMobile SDK streaming feature
...
class ShikharMobileStreamingFeature extends ShikharMobileBaseFeature
{
    ...
    private function _iterate(ShikharMobileResult $result): \Generator
    {
    ...
    private function _streamable(ShikharMobileContext $ctx): bool
    {
