...
// ShikharMobile SDK clienttrack feature
...
class ShikharMobileClienttrackFeature extends ShikharMobileBaseFeature
{
    ...
    public function PostConstruct(ShikharMobileContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ShikharMobile-SDK';
