...
// ShikharMobile SDK telemetry feature
...
class ShikharMobileTelemetryFeature extends ShikharMobileBaseFeature
{
    ...
    private function _close(ShikharMobileContext $ctx, bool $ok): void
    {
