...
// ShikharMobile SDK netsim feature
...
class ShikharMobileNetsimFeature extends ShikharMobileBaseFeature
{
    ...
    private function _simulate(ShikharMobileContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ShikharMobileContext $ctx, array $applied): void
    {
        $client = $this->client;
