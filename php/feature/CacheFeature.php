...
// ShikharMobile SDK cache feature
...
class ShikharMobileCacheFeature extends ShikharMobileBaseFeature
{
    ...
    private function _through(ShikharMobileContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
