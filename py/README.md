...
The Python SDK for the ShikharMobile API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.ShikharMobile(None).load(
    {"id": "test01"}, None
)
