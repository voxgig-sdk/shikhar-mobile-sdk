# ShikharMobile Python SDK



The Python SDK for the ShikharMobile API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/shikhar-mobile-sdk/releases)) or
...
```python
client = ShikharMobileSDK.test(testopts, sdkopts)
```
...
```
py/
├── shikharmobile_sdk.py         -- Main SDK module
...
The main module (`shikharmobile_sdk`) exports the SDK class.
