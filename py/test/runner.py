...
class ShikharMobileTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ShikharMobileTestRunner.getenv("SHIKHARMOBILE_TEST_LIVE")
        override = ShikharMobileTestRunner.getenv("SHIKHARMOBILE_TEST_OVERRIDE")
        ...
        explain = ShikharMobileTestRunner.getenv("SHIKHARMOBILE_TEST_EXPLAIN")
