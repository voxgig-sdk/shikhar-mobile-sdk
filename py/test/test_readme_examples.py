# ShikharMobile SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ShikharMobileSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ShikharMobileSDK(...) and ShikharMobileSDK.test(...) become
#      ShikharMobileSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "shikharmobile_sdk"
_SDK_CLASS = "ShikharMobileSDK"
