...
from shikharmobile_sdk.utility import register

# Load features
from shikharmobile_sdk.feature.base_feature import ShikharMobileBaseFeature
from shikharmobile_sdk.features import _has_feature, _make_feature
...
class ShikharMobileSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ShikharMobileUtility()
        self._utility = utility

        from shikharmobile_sdk.config import shared_config
    ...
    def get_utility(self):
        return ShikharMobileUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ShikharMobileSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Authentication(self, data=None) -> "AuthenticationEntity":
        ...
        from shikharmobile_sdk.entity.authentication_entity import AuthenticationEntity
        return AuthenticationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ShikharMobileSDK":
        if sdkopts is None:
            sdkopts = {}
