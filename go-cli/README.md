...
AQL-driven CLI and REPL for the ShikharMobile SDK. Positional arguments are
...
./shikhar-mobile-cli list authentication
./shikhar-mobile-cli load 1 authentication
./shikhar-mobile-cli load '{id:1}' authentication
