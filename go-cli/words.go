...
func registerSDKWords(r *eng.Registry, client *sdk.ShikharMobileSDK) {
...
func runOp(client *sdk.ShikharMobileSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
