// Command ShikharMobile-cli is a CLI + REPL for the ShikharMobile SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      SHIKHAR_MOBILE_APIKEY (api key), SHIKHAR_MOBILE_BASE (base url override)")
